...
var daten2=DateFormat("yyyy-MM-dd").format(day3);
// final day3 = date.add(new Duration(days: 2));
...
class Trainer2 extends StatefulWidget {
 Trainer2({Key key}) : super(key: key);

  @override
  _Trainer2State createState() => _Trainer2State();
}

class _Trainer2State extends State<Trainer2> {
                  ...
                  onTap: ()async {
                    ...
                    if(s1==false&&g1==false)
                    {
                      ...
                      global.tempForCategory="";
                                                  ...
                                                  "date_time":daten2.toString()+"T06:00:00.000Z",
                  ...
                  onTap: ()async {
                    ...
                    if(s2==false&&g2==false)
                    {
                      ...
                      global.tempForCategory="";
                                                  ...
                                                  // "session_type":"gold",
                                                  // "trainer_status":"active"
                                                  "date_time":daten2.toString()+"T07:00:00.000Z",
                                                  "session_type":global.tempForCategory.toString(),
                                                  "trainer_status":global.tp.toString()      
                                  };
                                  print(data);
                  ...
                  onTap: ()async {
                    ...
                    if(s3==false&&g3==false)
                    {
                      ...
                      global.tempForCategory="";
                                                  ...
                                                  // "session_type":"gold",
                                                  // "trainer_status":"active"
                                                  "date_time":daten2.toString()+"T08:00:00.000Z",
                                                  "session_type":global.tempForCategory.toString(),
                                                  "trainer_status":global.tp.toString()      
                                  };
                                  print(data);
                  ...
                  onTap: ()async {
                    ...
                    if(s4==false&&g4==false)
                    {
                      ...
                      global.tempForCategory="";
                                                  ...
                                                  // "session_type":"gold",
                                                  // "trainer_status":"active"
                                                  "date_time":daten2.toString()+"T09:00:00.000Z",
                                                  "session_type":global.tempForCategory.toString(),
                                                  "trainer_status":global.tp.toString()      
                                  };
                                  print(data);
                 ...
                 onTap: ()async {
                    ...
                    if(s5==false&&g5==false)
                    {
                      ...
                      global.tempForCategory="";
                                                  ...
                                                  // "session_type":"gold",
                                                  // "trainer_status":"active"
                                                  "date_time":daten2.toString()+"T10:00:00.000Z",
                                                  "session_type":global.tempForCategory.toString(),
                                                  "trainer_status":global.tp.toString()      
                                  };
                                  print(data);
                ...
                onTap: ()async {
                    ...
                    if(s6==false&&g6==false)
                    {
                      ...
                      global.tempForCategory="";
                                                  ...
                                                  // "session_type":"gold",
                                                  // "trainer_status":"active"
                                                  "date_time":daten2.toString()+"T11:00:00.000Z",
                                                  "session_type":global.tempForCategory.toString(),
                                                  "trainer_status":global.tp.toString()      
                                  };
                                  print(data);
                  ...
                  onTap: ()async {
                    ...
                    if(s7==false&&g7==false)
                    {
                      ...
                      global.tempForCategory="";
                                                  ...
                                                  // "session_type":"gold",
                                                  // "trainer_status":"active"
                                                  "date_time":daten2.toString()+"T12:00:00.000Z",
                                                  "session_type":global.tempForCategory.toString(),
                                                  "trainer_status":global.tp.toString()      
                                  };
                                  print(data);
                 ...
                 onTap: ()async {
                    ...
                    if(s8==false&&g8==false)
                    {
                      ...
                      global.tempForCategory="";
                                                  ...
                                                  // "session_type":"gold",
                                                  // "trainer_status":"active"
                                                  "date_time":daten2.toString()+"T13:00:00.000Z",
                                                  "session_type":global.tempForCategory.toString(),
                                                  "trainer_status":global.tp.toString()      
                                  };
                                  print(data);
                 ...
                 onTap: ()async {
                    ...
                    if(s9==false&&g9==false)
                    {
                      ...
                      global.tempForCategory="";
                                                  ...
                                                  // "session_type":"gold",
                                                  // "trainer_status":"active"
                                                  "date_time":daten2.toString()+"T14:00:00.000Z",
                                                  "session_type":global.tempForCategory.toString(),
                                                  "trainer_status":global.tp.toString()      
                                  };
                                  print(data);
                  ...
                  onTap: ()async {
                    ...
                    if(s10==false&&g10==false)
                    {
                      ...
                      global.tempForCategory="";
                                                  ...
                                                  // "session_type":"gold",
                                                  // "trainer_status":"active"
                                                  "date_time":daten2.toString()+"T15:00:00.000Z",
                                                  "session_type":global.tempForCategory.toString(),
                                                  "trainer_status":global.tp.toString()      
                                  };
                                  print(data);
                ...
                onTap: ()async {
                    ...
                    if(s11==false&&g11==false)
                    {
                      ...
                      global.tempForCategory="";
                                                  ...
                                                  // "session_type":"gold",
                                                  // "trainer_status":"active"
                                                  "date_time":daten2.toString()+"T16:00:00.000Z",
                                                  "session_type":global.tempForCategory.toString(),
                                                  "trainer_status":global.tp.toString()      
                                  };
                                  print(data);
                  ...
                  onTap: ()async {
                    ...
                    if(s12==false&&g12==false)
                    {
                      ...
                      global.tempForCategory="";
                                                  ...
                                                  // "session_type":"gold",
                                                  // "trainer_status":"active"
                                                  "date_time":daten2.toString()+"T17:00:00.000Z",
                                                  "session_type":global.tempForCategory.toString(),
                                                  "trainer_status":global.tp.toString()      
                                  };
                                  print(data);
                  ...
                  onTap: ()async {
                    ...
                    if(s13==false&&g13==false)
                    {
                      ...
                      global.tempForCategory="";
                                                  ...
                                                  // "session_type":"gold",
                                                  // "trainer_status":"active"
                                                  "date_time":daten2.toString()+"T18:00:00.000Z",
                                                  "session_type":global.tempForCategory.toString(),
                                                  "trainer_status":global.tp.toString()      
                                  };
                                  print(data);
                ...
                onTap: ()async {
                    ...
                    if(s14==false&&g14==false)
                    {
                      ...
                      global.tempForCategory="";
                                                  ...
                                                  // "session_type":"gold",
                                                  // "trainer_status":"active"
                                                  "date_time":daten2.toString()+"T19:00:00.000Z",
                                                  "session_type":global.tempForCategory.toString(),
                                                  "trainer_status":global.tp.toString()      
                                  };
                                  print(data);
                  ...
                  onTap: ()async {
                    ...
                    if(s15==false&&g15==false)
                    {
                      ...
                      global.tempForCategory="";
                                                  ...
                                                  // "session_type":"gold",
                                                  // "trainer_status":"active"
                                                  "date_time":daten2.toString()+"T20:00:00.000Z",
                                                  "session_type":global.tempForCategory.toString(),
                                                  "trainer_status":global.tp.toString()      
                                  };
                                  print(data);
                  ...
                  onTap: ()async {
                    ...
                    if(s16==false&&g16==false)
                    {
                      ...
                      global.tempForCategory="";
                                                  ...
                                                  // "session_type":"gold",
                                                  // "trainer_status":"active"
                                                  "date_time":daten2.toString()+"T21:00:00.000Z",
                                                  "session_type":global.tempForCategory.toString(),
                                                  "trainer_status":global.tp.toString()      
                                  };
                                  print(data);
                ...
                onTap: ()async {
                    ...
                    if(s17==false&&g17==false)
                    {
                      ...
                      global.tempForCategory="";
                                                  ...
                                                  // "session_type":"gold",
                                                  // "trainer_status":"active"
                                                  "date_time":daten2.toString()+"T22:00:00.000Z",
                                                  "session_type":global.tempForCategory.toString(),
                                                  "trainer_status":global.tp.toString()      
                                  };
                                  print(data);
