...
class _AccountDetailsState extends State<AccountDetails> {
  ...
  callForDetails() async{
    var response =await http.get("http://34.93.104.9:3000/api/trainer/getaccountdetails",headers:{"Content-type": "application/x-www-form-urlencoded","token":global.token} );
